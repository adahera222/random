...
var Main = function() {
	...
	var stage = nme.Lib.get_current().get_stage();
	var textFormat = new browser.text.TextFormat();
	textFormat.font = "Courier";
	textFormat.color = 16711680;
	textFormat.size = 42;
	var text = new browser.text.TextField();
	text.set_text("Hello World!");
	text.set_x(nme.Lib.get_current().get_stage().get_stageWidth() / 2 - 145);
	text.set_y(nme.Lib.get_current().get_stage().get_stageHeight() / 2 - 21);
	text.set_width(290);
	text.setTextFormat(textFormat);
	nme.Lib.get_current().get_stage().addChild(text);
};
$hxClasses["Main"] = Main;
Main.__name__ = ["Main"];
Main.main = function() {
