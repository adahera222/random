...
function Intro:draw()
    ...
    local w = main_font_big:getWidth("(HAVE MORE THAN 50 BEINGS)")
    love.graphics.print("(HAVE MORE THAN 50 BEINGS)", game_width/2 - w/2 + 7*game_width, game_height/2 - 1.25*main_font_big:getHeight())
    love.graphics.setFont(main_font_huge)
    love.graphics.setColor(32, 32, 32, self.goal_alpha)
